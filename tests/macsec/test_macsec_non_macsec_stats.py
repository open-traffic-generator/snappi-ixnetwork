...
def test_encrypt(api, b2b_raw_config, utils):
    ...
    macsec1_int.eth_name = eth1.name
    ...
    secy1_dataplane_txsc1.tx_pn.choice = "fixed_pn"
    secy1_dataplane_txsc1.tx_pn.fixed.pn = 100

    # static key
    secy1_key_gen_proto = secy1.key_generation_protocol
    secy1_key_gen_proto.choice = "static_key"
    secy1_sk = secy1_key_gen_proto.static_key
    secy1_sk.cipher_suite = "gcm_aes_xpn_128"

    # Tx
    secy1_tx = secy1_sk.tx
    secy1_txsc1 = secy1_tx.secure_channels.add()

    # Tx SC end station
    #secy1_txsc1.end_station = True

    # Tx key
    secy1_tx_sak1 = secy1_txsc1.saks.add()
    #secy1_tx_sak1.sak = "0xF123456789ABCDEF0123456789ABCDEF"
    secy1_tx_sak1.sak = "f123456789abcdef0123456789abcdef"
    secy1_tx_sak1.ssci = "0000000a"
    secy1_tx_sak1.salt = "00000000000000000000000b"

    # Remaining Tx SC settings autofilled

    # Rx: Not required for stateless enryption only traffic
    #secy1_rx = secy1.rx
    #secy1_rxsc1 = secy1.rx.static_key.scs.add()

    # Rx SC
    #secy1_rxsc1.dut_system_id =  eth2.mac

    # Rx key
    #secy1_rx_sak1 = secy1_rxsc1.saks.add()
    #secy1_rx_sak1.sak = "0xF123456789ABCDEF0123456789ABCDEF"
    #secy1_rx_sak1.sak = "f123456789abcdef0123456789abcdef"
