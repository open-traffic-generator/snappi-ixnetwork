...
def test_ethernet_header(api, tx_port, rx_port, options, b2b_ipv4_devices):
    """Create flow with ethernet header.
    Ethernet header fields src, dst, pfc_queue consist of patterns.
    """
    ...
    flow = Flow(name='Test Ethernet Header',
                tx_rx=TxRx(endpoint),
                packet=[ethernet])
