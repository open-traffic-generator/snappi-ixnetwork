...
class TrafficItem(CustomField):
    ...
    _RESULT_ROCEV2_COLUMNS = [
        ...
        ("data_frames_tx", "Frames Tx", int),
        ("data_frames_rx", "Frames Rx", int),
        ("frame_delta", "Frames Delta", int),
        ("data_frames_retransmitted", "Frames ReTx", int),
        ("tx_bytes", "Bytes Tx", int),
        ("rx_bytes", "Bytes Rx", int),
        ("data_tx_rate", "Rate Tx (Gbps)", float),
        ("data_rx_rate", "Rate Rx (Gbps)", float),
        ("message_tx", "Messages Tx", int),
        ("message_complete_rx", "Messages Rx", int),
        ("message_fail", "Messages Failed", int),
        ("flow_completion_time", "FCT (ms)", int),
        ...
        ("nak_tx", "NAK Tx", int),
        ("nak_rx", "NAK Rx", int),
        ("frame_sequence_error", "Frames SeqError", int),
